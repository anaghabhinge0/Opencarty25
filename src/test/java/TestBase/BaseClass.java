...
public class BaseClass {
	...
	public Properties p;//for cofig.properties
...
public void teardown() {
	...
	public String randomeString() {
		String genetratedstring=RandomStringUtils.randomAlphabetic(6);
		return genetratedstring;
	}
	public String randomenumber() {
		String genetratednumber=RandomStringUtils.randomNumeric(10);
	    return genetratednumber;

	}
	public String randomealphnum() {
